<?php 
// Essentially, this page is the same as the add activity page, albeit slightly different?>
...
<div id="create_activity_form" class="main_content_area">
	...
	<table style="margin-left:50px;">
    	<tr>
        	<td><label for="author" class="required">What is your name?:</label></td>
...
function go_back() {
	window.location = "view_itinerary.php?i_id=<?php echo $i_id;?>";
}
